...
# bold button
bold_icon = tk.PhotoImage(file=r"C:\Users\sanjay\Desktop\project\bold.png")                   # creating a Bold Icon for the Bold Button
...
# italic button
italic_icon = tk.PhotoImage(file=r"C:\Users\sanjay\Desktop\project\italic.png")               # creating a Italic Icon for the Italic Button
...
# underline button
underline_icon = tk.PhotoImage(file=r"C:\Users\sanjay\Desktop\project\underline.png")         # creating a Underline Icon for the Underline Button
...
def about(event=None):
    os.startfile(r'"C:\Users\sanjay\Desktop\project\about.pyw"')  # Starting a file to show the about PyBook, only extension with (.pyw)
